...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('gj+Huqbcrm', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Yg0W+ggqq1', 0, 'KjAd8PDOJ5gO2F+qaVc6oB', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bQs39UBckq', 0, 'KjAd8PDOJ5gO2F+qaVc6oB', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('T7mXLFa+JW', 0, 'KjAd8PDOJ5gO2F+qaVc6oB', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'pidevsocialpro', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Esprit\\socialproBundle\\Entity'))), 'Esprit\\socialproBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('EspritsocialproBundle' => 'Esprit\\socialproBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ee26d19049c75d65e4f2b068b9a91089d1dcddf5cdffaab4b2fa0b09f2cd4b16');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Esprit\\socialproBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\TwigSwiftMailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('twig'), array('template' => array('confirmation' => '@FOSUser/Registration/email.txt.twig', 'resetting' => '@FOSUser/Resetting/email.txt.twig'), 'from_email' => array('confirmation' => array('webmaster@example.com' => 'webmaster'), 'resetting' => array('pisocial.pro@gmail.com' => 'social pro'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Esprit\\socialproBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Esprit\\socialproBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_resetting_form', 'FOS\\UserBundle\\From\\Type\\ResettingFormType', array(0 => 'ResetPassword', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Esprit\\socialproBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater'), $this->get('doctrine')->getManager(NULL), 'Esprit\\socialproBundle\\Entity\\User');
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('pisocial.pro@gmail.com');
        $a->setPassword(1901525);
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Esprit\\socialproBundle/Resources/views'), 'Espritsocialpro');
        $instance->addPath(($this->targetDirs[3].'\\src\\Esprit\\socialproBundle/Resources/views'), 'FOSUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1ea801e7bc94c62c0db882a3521fd6854b7a6709');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_CLIENT' => array(0 => 'ROLE_USER'), 'ROLE_AGENT' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'EspritsocialproBundle' => 'Esprit\\socialproBundle\\EspritsocialproBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'EspritsocialproBundle' => array(
                    'parent' => 'FOSUserBundle',
                    'path' => ($this->targetDirs[3].'\\src\\Esprit\\socialproBundle'),
            ...
            'mailer_user' => 'pisocial.pro@gmail.com',
            'mailer_password' => 1901525,
            'secret' => '1ea801e7bc94c62c0db882a3521fd6854b7a6709',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '1ea801e7bc94c62c0db882a3521fd6854b7a6709',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'pisocial.pro@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 1901525,
            ...
            'fos_user.model.user.class' => 'Esprit\\socialproBundle\\Entity\\User',
            ...
            'fos_user.resetting.email.from_email' => array(
                'pisocial.pro@gmail.com' => 'social pro',
            ),
            'fos_user.resetting.token_ttl' => 86400,
            'fos_user.resetting.form.type' => 'FOS\\UserBundle\\From\\Type\\ResettingFormType',
